...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        if len(self.contents) + len(additional_contents) > self.volume:
            ...
            self.contents += additional_contents[:self.volume - len(init_contents)]
            return str(additional_contents[self.volume - len(init_contents):])
    ...
    def shrink(self, new_volume):
        ...
        if len(self.contents) > self.volume:
            ...
            return str(init_contents[self.volume - len(init_contents):])
        return ''
    ...
    def double_then_shrink(self, new_volume):
        ...
        # ---------------------------------------------------------------------
        excess = self.double()
        return len(self.shrink(new_volume)) + len(excess)
    ...
    def steal(self, other_box):
        ...
        #    ** TWO **   LINES OF CODE.
        #######################################################################
        extra = self.append_string(other_box.contents)
